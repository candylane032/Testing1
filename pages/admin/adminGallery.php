...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <section>
                <div class="container">
                    <div class="modal mt-4" id="galleryView" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-centered ">
                            <div class="modal-content mt-4">
            ...
            <section>
                <div class="container">
                    <div class="modal mt-4" id="galleryUpdate" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">>
                        <div class="modal-dialog modal-dialog-centered ">
                            <div class="modal-content mt-4">
                                <div class="modal-body">
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
