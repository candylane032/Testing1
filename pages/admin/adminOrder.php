...
<body>
    ...
    <div class="main-container d-flex">
        ...
        <div class="content">
            ...
            <section>
                <div class="container">
                    <div class="modal mt-4" id="orderbyid" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            ...
                            <div class="modal-content overflow">
                                <div class="modal-body">
                                    ...
                                    <div class="form-area bg-white rounded-4">
                                        <h2 class="text-center mb-4">Review Order</h2>
                                        <div id="displayOrderDataById">
    ...
    <script src="../../plugins/privacy/adminOrders.js"></script>
