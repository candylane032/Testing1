...
<body>
                ...
                <div class="container">
                    <div class="basket">
                        <div class="inner-wrap row">
                            <h1 class=" mb-4 text-center fw-bold mt-4">Reservation List</h1>
                            <div class="col-12 col-lg-3">
                            </div>
                            <div class="search-container mb-3">
                                    <input type="text" id="reserveSearchInput" class="form-control" placeholder="Search user" onkeyup="reserveSearch()">
                            </div>
    ...
    <script src="../../plugins/privacy/adminBasket.js"></script>
