...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="section-header text-center mb-4">
                                <h1 class="fw-bold mt-4">Product List</h1>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-sm-12 mb-4">
                            <div class="AddButton text-end">
                                 <button data-bs-toggle="modal" data-bs-target="#addproduct" id="add" class="btn btn-primary btn-md">Add New</button>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content mt-5">
                                <div class="modal-body">
                                    ...
                                    <div class="p-4 " enctype="multipart/form-data">
                                        <h1 class="mb-4 text-center fw-bold">Add New Product</h1>
                                        <form action="#">
                                            <div class="mb-2">
                                            ...
                                            <div class="mb-2">
                                                ...
                                                <input type="file" id="img" class="form-control mb-2" >
                                            </div>
                                            <div class="mb-2">
    ...
    <script src="../../plugins/privacy/adminProduct.js"></script>
