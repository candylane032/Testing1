...
<head>
    ...
    <title>History Orders | Page</title>
</head>
...
<body>
                ...
                <div class="container">
                    <div class="history">
                        <div class="inner-wrap row p-1">
                            <h1 class=" mb-4 text-center fw-bold mt-5">Purchased Transaction</h1>
                            <div class="MessageButton text-end mb-2">
    ...
    <script src="../../plugins/privacy/customerOrderPaid.js"></script>
