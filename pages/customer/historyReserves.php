...
<head>
    ...
    <title>History Reserves | Page</title>
</head>
...
<body>
                        ...
                        <div class="inner-wrap row p-1">
                            ...
                            <div class="col-12 col-lg-12">
                                <table class="table table-light">
                                    ...
                                    <tbody id="displayBasketCancelled">
                            ...
                            <div class="modal-content mt-4">
                                <div class="modal-body">
                                    ...
                                    <div class="form-area bg-white rounded-4">
                                        <h1 class="text-center text-info">Review Reserve</h1>
    ...
    <script src="../../plugins/privacy/customerBasketCancelled.js"></script>
