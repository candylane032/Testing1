...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../chatCustomer1/chat.css">
	<link rel="stylesheet" href="../chatCustomer1/global.css">
...
<body>
        <nav class="navbar navbar-expand-lg fixed-top">
            <div class="container">
                <a class="navbar-brand" href="../../pages/customer/product.php"><img src="../../images/logo.png" class="logo" alt="Logo"></a>
                    ...
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0 text-uppercase">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="../../pages/customer/historyOrders.php">Purchased</a></li>
                                <li><a class="dropdown-item" href="../../pages/customer/historyReserves.php">Reserved</a></li>
                            </ul>
                        </li>
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown"
	...
	<script src="../chatCustomer1/users.js"></script>
