...
<body>
    ...
    <div class="main-container d-flex">
        <div class="sidebar" id="side_nav">
            ...
            <p class="text-center text-white mt-3 text-uppercase"><?php echo $_SESSION['username']; ?><span>
                </span></p>
                ...
                <div class="container p-5">
                    <div class="row bg-light mt-5 p-5 chat">
                     <h1 class="text-center">ChatBox</h1>
                        ...
                        <div class="messageReceived" id="messageReceived"></div>
	...
	<script src="../../../plugins/privacy/chatA.js"></script>
