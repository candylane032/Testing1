                    ...
                    str += '<div class="card text-center pb-2">';
                        ...
                        str += '<h3 class="card-title">'+ element.r_name +'</h3>';
                            str += '<div class="img-area text-center">';
                                str += '<img class="fish" alt="" src="../../uploads/recipeImage/'+ element.r_image +'">';
                                str += '<div class="d-flex align-items-center justify-content-center">';
                                    ...
                                    str += '<button recipe_id="' + element.recipe_id + '" data-bs-toggle="modal" data-bs-target="#recipesUpdate" class="btn btn-warning btn-sm mt-3 btn-recipe-update">Update</button>';
                                str += '</div>';
                            str += '</div>';
                        str += '</div>';
                    str += '</div>';
            ...
            str += '<h3 class="card-title">'+ e.r_name +'</h3>';
                str += '<div class="img-area text-center">';
                    ...
                    str += '<div class="d-flex align-items-center justify-content-center">';
                        ...
                        str += '<button recipe_id="' + e.recipe_id + '" data-bs-toggle="modal" data-bs-target="#recipesUpdate" class="btn btn-warning btn-sm mt-3 mx-2 btn-recipe-update">Update</button>';
                    str += '</div>';
                str += '</div>';
            str += '</div>';
        str += '</div>';
        ...
        success: function(data) {
            ...
            json1.forEach(element1 => {
                ...
                str1 += '<div class="mb-2 mt-4 text-center">';
                    ...
                    str1 += '<img class="fish modalImage rounded" alt="" src="../../uploads/recipeImage/'+ element1.r_image +'">';
                str1 += '</div>';
