    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            json3.forEach(element3 => {
                ...
                str3 += '</div">';
                str3 += '<div class="mb-1">';
                    str3 += '<button user_id="' + element3.user_id + '" class="btn btn-sm btn-primary mt-2 btn-update-profilePic">UPDATE</button>';
                str3 += '</div">';
            ...
            json.forEach(element => {
                ...
                str += '<div class="rowProfile row">';
                    str += '<div class="col-12 col-lg-5">';
                        ...
                        str += '<p class="text-capitalize">' + element.fname + '</p>';
                        str += '<label class="fw-bold text-muted">Gender</label>';
                        str += '<p class="text-capitalize">' + element.gender + '</p>';
                        str += '<label class="fw-bold text-muted">Address</label>';
                        str += '<p class="text-capitalize">' + element.address + '</p>';

                    str += '</div>';
                    str += '<div class="col-12 col-lg-5">';
                        str += '<label class="fw-bold text-muted">Last Name</label>';
                        str += '<p class="text-capitalize">' + element.lname + '</p>';
                ...
                str += '<div class="rowProfile row">';
                    str += '<div class="col-12 col-lg-10">';
                        str += '<button data-bs-toggle="modal" data-bs-target="#update" profile_id=' + element.profile_id + ' class="btn btn-md bg-secondary Button-display-profile">'  + '<i class="bi bi-pencil-square"></i>' + '</button>';
                    str += '</div>';
                str += '</div>';
                profile++;
    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            json1.forEach(element1 => {
                ...
                str1 += '<h1 class="text-center text-warning">Update Profile</h1>';
                ...
                str1 += '</div>';
                str1 += '<div class="mb-1">';
                    str1 += '<button id="btn-update-profile" class="btn mt-3 text-white">Update</button>';
                str1 += '</div>';
