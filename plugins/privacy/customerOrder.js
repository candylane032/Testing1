        ...
        success: function(data) {
            ...
            json1.forEach(element1 => {
                ...
                //   str1 += '<td data-label="ID">' + element1.order_id + '</td>';
                  ...
                  str1 += '<td class="text-warning fw-bold text-capitalize">' + element1.o_payment_status + '</td>';
                  ...
                  str1 += '<td data-label="ACTION">';
                    str1 += '<button order_id="' + element1.order_id + '" data-bs-toggle="modal" data-bs-target="#view" class="btn btn-sm btn-info mx-1 btn-View">View</button>';
                    // str1 += '<button class="btn btn-sm btn-success"><a class="text-decoration-none text-white" href="../chatCustomer1/chat.php">Message</a></button>';
                  str1 += '</td>';
                str1 += '</tr>';
                ...
                str2 +='<div class="row mt-2 p-3 mb-3">';
                    str2 +='<div class="col-12 col-lg-6">';
                        ...
                        str2 +='<div class="mb-3">';
                            ...
                            str2 +='<div><img class="orderImg rounded" src="../../uploads/productImage/'+ element2.img +'"></div>';
                        str2 +='</div>';
                        str2 +='<div class="mb-3">';
