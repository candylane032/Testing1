  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      json2.forEach((element2) => {
        ...
        str2 += '<button reserve_id="' + element2.reserve_id + '" data-bs-toggle="modal" data-bs-target="#view" class="btn-reserve mx-1 btn-View">View</button>';
        str2 += '</td>';
        str2 += '</tr>';
      });
  ...
  $.ajax({
    ...
    success: function (data) {
      ...
      json3.forEach(element3 => {
        ...
        str3 += '<div><img class="orderImg rounded object-fit-cover" src="../../uploads/productImage/' + element3.img + '"></div>';
        str3 += '</div>';
        str3 += '<div class="mb-3">';
