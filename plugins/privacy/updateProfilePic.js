    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            json3.forEach(element3 => {
                ...
                str3 += '</div">';
                str3 += '<div class="mb-1">';
                str3 += '<button user_id="' + element3.user_id + '" class="btn-order mt-3 btn-update-profilePic">Update</button>';
                str3 += '</div">';
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            json1.forEach(element1 => {
                ...
                str1 += '<h2 class="text-center">Complete your Information</h2>';
                ...
                str1 += '</div>';
                str1 += '<div class="mb-1">';
                str1 += '<button id="btn-update-profile" class="btn-reserve mt-3">Update</button>';
                str1 += '</div>';
