    ...
    $.ajax({
        ...
        success: function(data) {
            ...
            json1.forEach(element1 => {
                ...
                str1 += '<div class="mb-3 mt-4 text-center">';
                    // str1 += '<label class="fw-bold">Current Image: '+ element1.g_image +'</label><br>';
                    str1 += '<img class="fish modalImage" alt="" src="../../uploads/galleryImage/'+ element1.g_image +'">';
                str1 += '</div>';
