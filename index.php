		...
		<div class="carousel slide" data-bs-ride="carousel" id="carouselExampleIndicators">
			...
			<div class="carousel-inner">
				<div class="carousel-item active">
					<img alt="..." class="d-block w-100" src="images/caro-3.jpg">
					<div class="carousel-caption">
						<h5>CHARLYN'S SEAFOOD <br> ESSENTIALS</h5>
						<p>From time to time, treat yourself with some seafood.</p>
						<button  class="btn-started"><a class="text-decoration-none text-white" href="pages/customer/register.php">Get Started</a></button>
						<button  class="btn-in  mt-4 mx-2 px-4"><a class="text-decoration-none text-white" href="pages/customer/login.php">Sign In</a></button>
					</div>
				</div>
				<div class="carousel-item">
					<img alt="..." class="d-block w-100" src="images/car-2.jpg">
					<div class="carousel-caption">
					<h5>CHARLYN'S SEAFOOD <br> ESSENTIALS</h5>
				...
				<div class="carousel-item">
					<img alt="..." class="d-block w-100" src="images/caro-1.jpg">
					<div class="carousel-caption">
					<h5>CHARLYN'S SEAFOOD <br> ESSENTIALS</h5>
			...
			<div class="row">
				<div class="col-lg-8 col-md-12 col-12 ps-lg-5 mt-md-5">
					<div class="about-text">
						...
						<button class="btn-order"><a class="text-decoration-none text-white" href="pages/customer/login.php">Order Now</a></button>
					</div>
				</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="section-header text-center pb-5">
						...
						<p>The CSE owner always make sure that the products are all in best variations of best quality.</p>
					</div>
				</div>
			</div>
			<div class="row">
